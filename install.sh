...
echo -e "${CYAN}║${NC}    Username : (diatur via ADMIN_USERNAME env var, default: admin) ${CYAN}║${NC}"
echo -e "${CYAN}║${NC}    Password : (diatur via ADMIN_PASSWORD env var, acak jika kosong) ${CYAN}║${NC}"
echo -e "${CYAN}║${NC}                                                       ${CYAN}║${NC}"
